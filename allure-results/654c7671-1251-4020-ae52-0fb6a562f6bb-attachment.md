...
- Name: Checkbox\check.test.ts >> Multiple Cities
- Location: tests\Checkbox\check.test.ts:54:1
...
Error: locator.click: Error: strict mode violation: getByText('Paris') resolved to 2 elements:
    ...
    2) <label for="1b6d8338-7a04-4a97-946b-7be3e610c49f">Paris</label> aka locator('[id="j_idt87:multiple_panel"]').getByText('Paris')
  ...
  - generic [ref=e2]:
    - generic [ref=e3]:
      - link [ref=e4] [cursor=pointer]:
        - /url: /dashboard.xhtml;jsessionid=node0hqy02h3h3lrr13ht6s45yxr1w19715453.node0
      - text: 
