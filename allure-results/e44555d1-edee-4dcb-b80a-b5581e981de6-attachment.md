...
```
Error: locator.fill: Error: strict mode violation: locator('[id="user-message"]') resolved to 3 elements:
        ...
        - generic [ref=e50]:
          ...
          - generic [ref=e53]:
            - generic [ref=e54]:
              ...
              - textbox "Please enter your Message" [active] [ref=e56]
...
```ts
  ...
  12 |      console.log(msg);
  13 |      await page.getByPlaceholder('Please enter your Message').click();
> 14 |      await page.locator('[id="user-message"]').fill('Arun');
     |                                                ^ Error: locator.fill: Error: strict mode violation: locator('[id="user-message"]') resolved to 3 elements:
