...
Call log:
  - waiting for locator('[id="message"]')
        ...
        - generic [ref=e50]:
          ...
          - generic [ref=e53]:
            - generic [ref=e54]:
              ...
              - textbox "Please enter your Message" [ref=e56]: Arun
...
```ts
  ...
  13 |      await page.getByPlaceholder('Please enter your Message').fill('Arun');
  14 |      await page.getByRole('button',{name:'Get Checked Value'}).click();
> 15 |      const aftermsg=await page.locator('[id="message"]').inputValue();
     |                                                          ^ Error: locator.inputValue: Error: Node is not an <input>, <textarea> or <select> element
