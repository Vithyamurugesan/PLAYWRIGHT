...
```
Error: locator.textContent: Error: strict mode violation: locator('.mt-20') resolved to 7 elements:
    1) <p class="text-gray-900 text-size-15 mt-20 text-black mb-10 font-semibold">Enter Message</p> aka getByText('Enter Message')
    2) <button type="button" id="showInput" class="mt-20 mb-10 bg-lambda-900 hover:bg-transparent hover:text-lambda-900 border border-lambda-900 text-white p-10 rounded focus:outline-none w-180">Get Checked Value</button> aka getByRole('button', { name: 'Get Checked Value' })
    3) <p id="message" class="mt-20"></p> aka locator('#message')
    4) <p class="text-gray-900 text-size-15 mt-20 text-black mb-10 font-semibold">Enter first value</p> aka getByText('Enter first value')
    5) <p class="text-gray-900 text-size-15 mt-20 text-black mb-10 font-semibold">Enter second value</p> aka getByText('Enter second value')
    6) <button type="button" class="mt-20 mb-10 bg-lambda-900 hover:bg-transparent hover:text-lambda-900 border border-lambda-900 text-white rounded p-10 focus:outline-none w-180 ">Get Sum</button> aka getByRole('button', { name: 'Get Sum' })
    7) <p class="mt-20" id="addmessage"></p> aka locator('#addmessage')

Call log:
  - waiting for locator('.mt-20')
...
- generic [ref=e3]:
        ...
        - generic [ref=e60]:
          ...
          - generic [ref=e63]:
            - generic [ref=e65]:
              ...
              - textbox "Please enter first value" [ref=e67]: "10"
              - paragraph [ref=e68]: Enter second value
              - textbox "Please enter second value" [ref=e69]: "20"
  ...
  - contentinfo [ref=e73]:
    - generic [ref=e74]:
          ...
          - generic [ref=e308]:
            - generic [ref=e309]:
              ...
              - generic [ref=e311]:
                ...
                - link "Claude AI Icon" [ref=e316] [cursor=pointer]:
                  ...
                  - img "Claude AI Icon" [ref=e317]
                - link "Grok Icon" [ref=e318] [cursor=pointer]:
                  ...
                  - img "Grok Icon" [ref=e319]
                - link "Google AI Icon" [ref=e320] [cursor=pointer]:
                  ...
                  - img "Google AI Icon" [ref=e321]
            - paragraph [ref=e322]: TestMu AI (formerly LambdaTest) has formal standards certification and comply in line with acts and regulations across the globe.
            - img "TestMu AI standards certification" [ref=e323]
            - paragraph [ref=e324]: LambdaTest is TestMu AI
            - paragraph [ref=e325]:
              - img [ref=e326]
              - text: Headquarters
            - link "1 Sutter Street, Suite 500, San Francisco, California 94104" [ref=e330] [cursor=pointer]:
      ...
      - generic [ref=e331]:
        - paragraph [ref=e332]: How can we help?
        - button "Contact Us White Arrow White Arrow" [ref=e334] [cursor=pointer]:
          - text: Contact Us
          - generic [ref=e335]:
    ...
    - generic [ref=e359]:
      ...
      - list [ref=e364]:
        - listitem [ref=e365]:
          - link "Like TestmuAI on Facebook" [ref=e366] [cursor=pointer]:
            - /url: https://www.facebook.com/testmuai/
            - img "Like TestmuAI on Facebook" [ref=e367]
        - listitem [ref=e368]:
          - link "Follow TestmuAI on Twitter" [ref=e369] [cursor=pointer]:
            - /url: https://x.com/testmuai
            - img "TestmuAI Twitter" [ref=e370]
        - listitem [ref=e371]:
          - link "Follow TestmuAI on LinkedIn" [ref=e372] [cursor=pointer]:
            - /url: https://www.linkedin.com/company/testmu-ai/
            - img "Follow TestmuAI on Linkedin" [ref=e373]
        - listitem [ref=e374]:
          - link "Like TestmuAI on Youtube" [ref=e375] [cursor=pointer]:
            - /url: https://www.youtube.com/@TestMuAI
            - img "Subscribe TestmuAI on Youtube" [ref=e376]
        - listitem [ref=e377]:
          - link "Follow TestmuAI on Github" [ref=e378] [cursor=pointer]:
            - /url: https://github.com/LambdaTest/
            - img "GitHub" [ref=e379]
        - listitem [ref=e380]:
          - link "Follow TestmuAI on Pinterest" [ref=e381] [cursor=pointer]:
...
```ts
  ...
  13 | 
  14 |       const button = page.getByRole("button", { name: "Get Sum" });
  15 |       await button.click();
  16 | 
  17 |       const box=await page.getByRole("button",{name:'Get Sum'}).boundingBox();
  18 |       console.log(button.boundingBox());
  19 | 
> 20 |       const res=await page.locator('.mt-20').textContent()
     |                                              ^ Error: locator.textContent: Error: strict mode violation: locator('.mt-20') resolved to 7 elements:
  21 |       console.log(res);
  22 | 
  23 | })
