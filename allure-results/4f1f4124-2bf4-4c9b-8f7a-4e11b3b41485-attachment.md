        ...
        - generic [ref=e50]:
          ...
          - generic [ref=e53]:
            - generic [ref=e54]:
              ...
              - textbox "Please enter your Message" [ref=e56]: Vithya
...
> 16 |      const aftermsg=await page.locator('.mt-20').textContent();
     |                                                  ^ Error: locator.textContent: Error: strict mode violation: locator('.mt-20') resolved to 7 elements:
  17 |      console.log(aftermsg);
  18 |      await expect(page.locator('.mt-20')).toHaveText('Vithya');
  19 | 
  20 | 
  21 | });
  22 | 
