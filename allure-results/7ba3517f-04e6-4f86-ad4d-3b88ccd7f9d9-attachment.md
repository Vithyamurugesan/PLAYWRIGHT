...
```
Error: locator.click: Error: strict mode violation: locator('[class="border border-gray-550 w-full h-35 rounded px-10"]') resolved to 3 elements:
    ...
    2) <input id="sum1" type="text" placeholder="Please enter first value" class="border border-gray-550 w-full h-35 rounded px-10"/> aka getByRole('textbox', { name: 'Please enter first value' })
    3) <input id="sum2" type="text" placeholder="Please enter second value" class="border border-gray-550 w-full h-35 rounded px-10"/> aka getByRole('textbox', { name: 'Please enter second value' })

Call log:
  - waiting for locator('[class="border border-gray-550 w-full h-35 rounded px-10"]')
...
```ts
  ...
  9  | 
  10 |      await page.goto("https://www.testmuai.com/selenium-playground/simple-form-demo/");
  11 |      let msg=await page.getByText('Please enter your Message').allInnerTexts();
  12 |      console.log(msg);
> 13 |      await page.locator('[class="border border-gray-550 w-full h-35 rounded px-10"]').click();
     |                                                                                       ^ Error: locator.click: Error: strict mode violation: locator('[class="border border-gray-550 w-full h-35 rounded px-10"]') resolved to 3 elements:
  14 |      await page.locator('[class="border border-gray-550 w-full h-35 rounded px-10"]').fill('Arun');
  15 |      await page.getByRole('button',{name:'Get Checked Value'}).click();
  16 |      let aftermsg=await page.locator('[id="message"]')
  17 |      console.log(aftermsg);
  18 |     
  19 | 
  20 | 
  21 |      
