...
Expected: "Vithya"
Received: {"_apiName": "Locator", "_frame": {"_guid": "frame@6bcbaab4c2da9258c4a1fdc24454a689", "_type": "Frame"}, "_selector": "#message", Symbol(nodejs.util.inspect.custom): [Function anonymous]}
```
...
> 17 |      page.waitForTimeout(5000);
     |           ^ Error: page.waitForTimeout: Test ended.
  18 |      await expect(page.locator('#message')).toBe('Vithya');
  19 | 
  20 | 
  21 | });
  22 | 
